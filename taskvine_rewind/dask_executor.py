##
# @package distributed_NBRewind.dask_executor
#
# This module provides a specialized RewindManager to execute dask workflows
# with automatic task caching and replay capabilities.
#
...
from .vine_rewind import RewindManager

from .vine_rewind import PythonTask
from .vine_rewind import FunctionCall

# from ndcctools.taskvine.task import PythonTask
# from ndcctools.taskvine.task import FunctionCall
from ndcctools.taskvine.cvine import VINE_TEMP
...
##
# @class distributed_NBRewind.dask_executor.DaskVine
#
# RewindManager specialized to compute dask graphs with automatic caching.
#
# Managers created via DaskVine can be used to execute dask graphs via the method
# @ref distributed_NBRewind.dask_executor.DaskVine.get as follows:
#
# @code
# m = DaskVine(txlog_path="rewind.txlog")
# # Initialize as any other RewindManager
# result = v.compute(scheduler=m.get)
#
# # or set temporarily as the default for dask:
...
class PythonTaskDask(PythonTask):
    ...
    def __init__(self, m,
        ...
        # print(execute_graph_vertex, wrapper, key, sexpr, args, keys_of_files)
